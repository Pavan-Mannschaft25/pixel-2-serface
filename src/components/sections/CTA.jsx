...
//         <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-12 text-center text-white relative overflow-hidden">
...
//             >
//               Book a free consultation with our design experts and discover the
...
const CTA = () => {
  ...
  return (
    <section
      id="contact"
      className="section-padding relative overflow-hidden border border-b-white"
