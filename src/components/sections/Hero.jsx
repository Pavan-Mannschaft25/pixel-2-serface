...
// // // //   // Mouse transforms
// // // //   const orbX1 = useTransform(mouseX, [0, 1], [-20, 20]);
// // // //   const orbY1 = useTransform(mouseY, [0, 1], [-20, 20]);

// // // //   const orbX2 = useTransform(mouseX, [0, 1], [20, -20]);
// // // //   const orbY2 = useTransform(mouseY, [0, 1], [20, -20]);

// // // //   const orbX3 = useTransform(mouseX, [0, 1], [-30, 30]);
// // // //   const orbY3 = useTransform(mouseY, [0, 1], [-30, 30]);
...
// // // //         <motion.div
// // // //           className="absolute top-20 left-10 w-72 h-72 rounded-full blur-3xl opacity-30 bg-blue-400"
// // // //           style={{ x: orbX1, y: orbY1 }}
// // // //         />
// // // //         <motion.div
// // // //           className="absolute bottom-20 right-10 w-96 h-96 rounded-full blur-3xl opacity-30 bg-purple-400"
// // // //           style={{ x: orbX2, y: orbY2 }}
// // // //         />
// // // //         <motion.div
// // // //           className="absolute top-1/2 left-1/2 w-64 h-64 rounded-full blur-3xl opacity-20 bg-yellow-300"
...
// // // //       >
// // // //         <motion.h1
// // // //           className="text-5xl md:text-7xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-sky-400 bg-clip-text text-transparent"
// // // //           variants={item}
// // // //         >
// // // //           Pixel2Surface
// // // //         </motion.h1>

// // // //         <motion.p className="text-xl mb-2" variants={item}>
// // // //           Every surface has a story.
// // // //         </motion.p>

// // // //         <motion.p className="text-lg mb-8 max-w-2xl mx-auto" variants={item}>
...
// // // //           variants={item}
// // // //         >
// // // //           <Button variant="primary">View Designs</Button>
...
// // //         <motion.div
// // //           className="h-full bg-gradient-to-r from-royal-blue via-sky-blue to-purple-mauve"
...
// //   // Wall design samples with 3D positions
// //   const designSamples = [
// //     {
// //       id: 1,
...
// //         {/* Main 3D wall mockup */}
// //         <motion.div
// //           className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-96 md:w-96 md:h-[500px] bg-white/10 backdrop-blur-sm rounded-lg shadow-2xl overflow-hidden"
...
// //             {isTransforming && (
// //               <motion.div
// //                 className="absolute top-1/2 left-1/2 w-32 h-32 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 opacity-70 blur-xl"
...
// //             whileTap={{ scale: 0.95 }}
// //           >
// //             <Button variant="primary" onClick={handleTransformWall}>
// //               View Designs
// //             </Button>
// //           </motion.div>
// //           <motion.div
...
// //       <motion.div
// //         className="absolute top-20 right-20 w-16 h-16 rounded-full bg-gradient-to-br from-blue-500/30 to-purple-600/30 blur-xl"
// //         animate={{
// //           y: [0, -20, 0],
// //           x: [0, 10, 0],
// //           scale: [1, 1.2, 1],
...
// //       />
// //       <motion.div
// //         className="absolute bottom-32 left-20 w-20 h-20 rounded-full bg-gradient-to-br from-yellow-400/30 to-orange-500/30 blur-xl"
// //         animate={{
// //           y: [0, 15, 0],
// //           x: [0, -15, 0],
// //           scale: [1, 0.8, 1],
...
// //                 <motion.div
// //                   className="relative w-full h-full max-w-4xl max-h-[600px] rounded-xl overflow-hidden shadow-2xl"
// //                   style={{ transformStyle: "preserve-3d" }}
...
//         {is3DShowcaseOpen && (
//           <motion.div
//             className="fixed inset-0 z-50 flex items-center justify-center bg-blue/30 backdrop-blur-md overflow-hidden"
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
//             exit={{ opacity: 0 }}
//           >
...
//               <motion.div
//                 className="relative w-full h-full max-w-8xl max-h-[800px] flex items-center justify-center"
//                 style={{
//                   transformStyle: "preserve-3d",
...
//               {/* Close Button */}
//               <button
//                 className="absolute top-30 right-8 w-12 h-12 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center text-white hover:bg-white/20 transition-colors z-50 pointer-events-auto"
